...
<form action="{{ route('materials.store') }}" method="POST" class="mt-3">
    ...
    <div class="mb-3 mt-3">
        ...
        <input type="text" id="name" class="form-control @error('name') border-danger @enderror" placeholder="Enter material name" name="name" value="{{ old('name') }}" required autofocus>
    </div>
    ...
    <div class="mb-3 mt-3">
        ...
        <input type="number" step="0.001" id="opening-balance" class="form-control @error('opening_balance') border-danger @enderror" placeholder="Enter opening balance" name="opening_balance" value="{{ old('opening_balance') }}" required>
    </div>
